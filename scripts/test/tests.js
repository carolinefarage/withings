...
try {
  ...
  //results.deleteSubscriptionStatusAgain = notificationManager.deleteSubscription({callbackUrl: "https://api.scriptrapps.io/modules/withings/api/handleEvent.js?auth_token=RzM1RkYsdfc4Mg==", notificationType:common.notificationTypes.WEIGHT});
  return results;
}catch(exception){
